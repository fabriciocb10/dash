      ...
      function ( $stateProvider,   $urlRouterProvider,  MODULE_CONFIG, api ) {
        ...
        $stateProvider
          .state('app', {
            ...
            .state('app.tables', {
              url: '/tables/:product_id',
              templateUrl: 'views/pages/dash.tables.tpl.html',
              data: { title: 'Tablas' },
              controller: 'tablesCtrl',
              resolve: (function() {
                var promises = load(['smart-table', 'xeditable', ctrl.tables, direc.table, util.arrayUtil, filt.capitalize]);
          ...
          .state('ui', {
            ...
            .state('ui.tarjeta-regalo', {
              url: '/tarjeta-regalo',
              templateUrl: 'views/ui/chart/tarjeta-regalo.html',
              data : { title: 'Tarjeta de Regalo' },
